...
const Salary = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto py-6 pb-20 px-4 lg:px-0">
            ...
            <div className="bg-white p-6 lg:p-12 rounded-[40px] shadow-2xl shadow-emerald/5 border border-charcoal/5 mb-12 relative overflow-hidden">
